...
@section('title', 'Add Weight Reading')

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">Add Weight Reading</h1>
...
<div class="card">
    <form action="{{ route('patients.weight-readings.store', $patient) }}" method="POST" class="form" id="reading-form">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="weight" name="weight" class="form-input" value="{{ old('weight') }}" min="0" max="1000" step="0.01" required>
                    @error('weight')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
