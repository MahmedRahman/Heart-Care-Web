...
@section('title', 'All Weight Readings')

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">All Weight Readings</h1>
            <p class="page-subtitle">View all weight readings from all patients</p>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('patients.weight-readings.edit', [$reading->patient, $reading]) }}" class="btn-icon btn-edit" title="Edit">
                                    Edit
                                </a>
                                <form action="{{ route('patients.weight-readings.destroy', [$reading->patient, $reading]) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this reading?');">
                                    @csrf
                                    @method('DELETE')
