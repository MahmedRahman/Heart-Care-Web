...
@section('title', 'Edit Blood Pressure Reading')

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">Edit Blood Pressure Reading</h1>
...
<div class="card">
    <form action="{{ route('patients.blood-pressure-readings.update', [$patient, $bloodPressureReading]) }}" method="POST" class="form" id="reading-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" id="date" name="date" class="form-input" value="{{ old('date', $bloodPressureReading->date->format('Y-m-d')) }}" required>
                    @error('date')
                ...
                <div class="form-group">
                    ...
                    <input type="time" id="time" name="time" class="form-input" value="{{ old('time', date('H:i', strtotime($bloodPressureReading->time))) }}" required>
                    @error('time')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="systolic_bp" name="systolic_bp" class="form-input" value="{{ old('systolic_bp', $bloodPressureReading->systolic_bp) }}" min="50" max="300" required>
                    @error('systolic_bp')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="systolic_unit" name="systolic_unit" class="form-select" required>
                        <option value="mmHg" {{ old('systolic_unit', $bloodPressureReading->systolic_unit) == 'mmHg' ? 'selected' : '' }}>mmHg</option>
                        <option value="kPa" {{ old('systolic_unit', $bloodPressureReading->systolic_unit) == 'kPa' ? 'selected' : '' }}>kPa</option>
                    </select>
                    @error('systolic_unit')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="diastolic_bp" name="diastolic_bp" class="form-input" value="{{ old('diastolic_bp', $bloodPressureReading->diastolic_bp) }}" min="30" max="200" required>
                    @error('diastolic_bp')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="diastolic_unit" name="diastolic_unit" class="form-select" required>
                        <option value="mmHg" {{ old('diastolic_unit', $bloodPressureReading->diastolic_unit) == 'mmHg' ? 'selected' : '' }}>mmHg</option>
                        <option value="kPa" {{ old('diastolic_unit', $bloodPressureReading->diastolic_unit) == 'kPa' ? 'selected' : '' }}>kPa</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="map" name="map" class="form-input" value="{{ old('map', $bloodPressureReading->map) }}" min="40" max="200" step="0.01">
                    @error('map')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="map_unit" name="map_unit" class="form-select">
                        <option value="mmHg" {{ old('map_unit', $bloodPressureReading->map_unit) == 'mmHg' ? 'selected' : '' }}>mmHg</option>
                        <option value="kPa" {{ old('map_unit', $bloodPressureReading->map_unit) == 'kPa' ? 'selected' : '' }}>kPa</option>
                    </select>
                    @error('map_unit')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="heart_rate" name="heart_rate" class="form-input" value="{{ old('heart_rate', $bloodPressureReading->heart_rate) }}" min="30" max="250">
                    @error('heart_rate')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="heart_rate_unit" name="heart_rate_unit" class="form-select">
                        <option value="bpm" {{ old('heart_rate_unit', $bloodPressureReading->heart_rate_unit) == 'bpm' ? 'selected' : '' }}>bpm</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <textarea id="symptoms" name="symptoms" class="form-textarea" rows="4" placeholder="Enter any symptoms or notes...">{{ old('symptoms', $bloodPressureReading->symptoms) }}</textarea>
                    @error('symptoms')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
...
<script>
    ...
    function calculateMAP() {
        ...
        if (systolic > 0 && diastolic > 0 && mapInput) {
