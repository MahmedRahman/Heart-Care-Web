...
@section('title', 'Add Random Blood Sugar Reading')

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">Add Random Blood Sugar Reading</h1>
...
<div class="card">
    <form action="{{ route('patients.random-blood-sugar-readings.store', $patient) }}" method="POST" class="form" id="reading-form">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="random_blood_sugar" name="random_blood_sugar" class="form-input" value="{{ old('random_blood_sugar') }}" min="0" max="1000" step="0.01" required>
                ...
                <div class="form-group">
                    ...
                    <select id="random_blood_sugar_unit" name="random_blood_sugar_unit" class="form-select" required>
                        <option value="mg/dL" {{ old('random_blood_sugar_unit', 'mg/dL') == 'mg/dL' ? 'selected' : '' }}>mg/dL</option>
                        <option value="mmol/L" {{ old('random_blood_sugar_unit') == 'mmol/L' ? 'selected' : '' }}>mmol/L</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="insulin_dose" name="insulin_dose" class="form-input" value="{{ old('insulin_dose') }}" min="0" max="1000" step="0.01">
                    @error('insulin_dose')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="insulin_dose_unit" name="insulin_dose_unit" class="form-select">
                        <option value="units" {{ old('insulin_dose_unit', 'units') == 'units' ? 'selected' : '' }}>units</option>
                        <option value="IU" {{ old('insulin_dose_unit') == 'IU' ? 'selected' : '' }}>IU</option>
                    </select>
