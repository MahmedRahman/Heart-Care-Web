...
@section('title', 'Add Fluid Balance Reading')

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">Add Fluid Balance Reading</h1>
...
<div class="card">
    <form action="{{ route('patients.fluid-balance-readings.store', $patient) }}" method="POST" class="form" id="reading-form">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="fluid_intake" name="fluid_intake" class="form-input" value="{{ old('fluid_intake') }}" min="0" max="10000" step="0.01">
                    @error('fluid_intake')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="fluid_intake_unit" name="fluid_intake_unit" class="form-select">
                        <option value="mL" {{ old('fluid_intake_unit', 'mL') == 'mL' ? 'selected' : '' }}>mL</option>
                        <option value="L" {{ old('fluid_intake_unit') == 'L' ? 'selected' : '' }}>L</option>
                        <option value="oz" {{ old('fluid_intake_unit') == 'oz' ? 'selected' : '' }}>oz</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="fluid_output" name="fluid_output" class="form-input" value="{{ old('fluid_output') }}" min="0" max="10000" step="0.01">
                    @error('fluid_output')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="fluid_output_unit" name="fluid_output_unit" class="form-select">
                        <option value="mL" {{ old('fluid_output_unit', 'mL') == 'mL' ? 'selected' : '' }}>mL</option>
                        <option value="L" {{ old('fluid_output_unit') == 'L' ? 'selected' : '' }}>L</option>
                        <option value="oz" {{ old('fluid_output_unit') == 'oz' ? 'selected' : '' }}>oz</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="net_balance" name="net_balance" class="form-input" value="{{ old('net_balance') }}" step="0.01" readonly style="background-color: var(--md-sys-color-surface-variant);">
                ...
                <div class="form-group">
                    ...
                    <select id="net_balance_unit" name="net_balance_unit" class="form-select">
                        <option value="mL" {{ old('net_balance_unit', 'mL') == 'mL' ? 'selected' : '' }}>mL</option>
                        <option value="L" {{ old('net_balance_unit') == 'L' ? 'selected' : '' }}>L</option>
                        <option value="oz" {{ old('net_balance_unit') == 'oz' ? 'selected' : '' }}>oz</option>
                    </select>
