...
<div class="page-header">
    <div class="page-header-content">
        <div>
            ...
            <p class="page-subtitle">Create a new patient account with basic information</p>
        </div>
...
<div class="card">
    <form action="{{ route('patients.store') }}" method="POST" class="form" id="patient-form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <p class="form-hint">Upload a profile image (JPEG, PNG, JPG, GIF - Max: 2MB)</p>
                    @error('profile_image')
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="age" name="age" class="form-input" value="{{ old('age') }}" min="0" max="150">
                    @error('age')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="race" name="race" class="form-select select2-single">
                        ...
                        <option value="african" {{ old('race') == 'african' ? 'selected' : '' }}>African</option>
                        <option value="asian" {{ old('race') == 'asian' ? 'selected' : '' }}>Asian</option>
                        <option value="caucasian" {{ old('race') == 'caucasian' ? 'selected' : '' }}>Caucasian</option>
                        <option value="hispanic" {{ old('race') == 'hispanic' ? 'selected' : '' }}>Hispanic</option>
                        <option value="native_american" {{ old('race') == 'native_american' ? 'selected' : '' }}>Native American</option>
                        <option value="pacific_islander" {{ old('race') == 'pacific_islander' ? 'selected' : '' }}>Pacific Islander</option>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="marital_state" name="marital_state" class="form-select select2-single">
                        ...
                        <option value="single" {{ old('marital_state') == 'single' ? 'selected' : '' }}>Single</option>
                        <option value="married" {{ old('marital_state') == 'married' ? 'selected' : '' }}>Married</option>
                        <option value="divorced" {{ old('marital_state') == 'divorced' ? 'selected' : '' }}>Divorced</option>
                        <option value="widowed" {{ old('marital_state') == 'widowed' ? 'selected' : '' }}>Widowed</option>
                        <option value="separated" {{ old('marital_state') == 'separated' ? 'selected' : '' }}>Separated</option>
                    </select>
                    @error('marital_state')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="mobile_number" name="mobile_number" class="form-input" value="{{ old('mobile_number') }}" required>
                    @error('mobile_number')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="address_area" name="address_area" class="form-input" value="{{ old('address_area') }}">
                    @error('address_area')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address_street" name="address_street" class="form-input" value="{{ old('address_street') }}">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="weight" name="weight" class="form-input" value="{{ old('weight') }}" step="0.01" min="0" max="500">
                    @error('weight')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="height" name="height" class="form-input" value="{{ old('height') }}" step="0.01" min="0" max="300">
                    @error('height')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="bsa" name="bsa" class="form-input" value="{{ old('bsa') }}" step="0.01" min="0">
                    @error('bsa')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="bmi" name="bmi" class="form-input" value="{{ old('bmi') }}" step="0.01" min="0" max="100">
                    @error('bmi')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="primary_diagnosis" name="primary_diagnosis" class="form-select select2-single">
                        ...
                        @foreach($primaryDiagnoses as $diagnosis)
                            <option value="{{ $diagnosis->name }}" {{ old('primary_diagnosis') == $diagnosis->name ? 'selected' : '' }}>{{ $diagnosis->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="secondary_diagnosis" name="secondary_diagnosis[]" class="form-select select2-multiple" multiple>
                        @foreach($secondaryDiagnoses as $diagnosis)
                            <option value="{{ $diagnosis->name }}" {{ in_array($diagnosis->name, old('secondary_diagnosis', [])) ? 'selected' : '' }}>{{ $diagnosis->name }}</option>
                        @endforeach
                    </select>
                    <p class="form-hint"><a href="{{ route('diagnoses.create') }}" target="_blank" tabindex="-1">Add new diagnosis</a></p>
                ...
                <div class="form-group">
                    ...
                    <select id="tertiary_diagnosis" name="tertiary_diagnosis[]" class="form-select select2-multiple" multiple>
                        @foreach($tertiaryDiagnoses as $diagnosis)
                            <option value="{{ $diagnosis->name }}" {{ in_array($diagnosis->name, old('tertiary_diagnosis', [])) ? 'selected' : '' }}>{{ $diagnosis->name }}</option>
                        @endforeach
                    </select>
                    <p class="form-hint"><a href="{{ route('diagnoses.create') }}" target="_blank" tabindex="-1">Add new diagnosis</a></p>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <input type="text" id="hospital_id" name="hospital_id" class="form-input" value="{{ old('hospital_id') }}" required>
                    @error('hospital_id')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="clinic_name" name="clinic_name" class="form-input" value="{{ old('clinic_name') }}">
                    @error('clinic_name')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="physician_team_name" name="physician_team_name" class="form-select select2-single">
                        ...
                        <option value="Dr. John Smith" {{ old('physician_team_name') == 'Dr. John Smith' ? 'selected' : '' }}>Dr. John Smith</option>
                        <option value="Dr. Sarah Johnson" {{ old('physician_team_name') == 'Dr. Sarah Johnson' ? 'selected' : '' }}>Dr. Sarah Johnson</option>
                        <option value="Dr. Michael Brown" {{ old('physician_team_name') == 'Dr. Michael Brown' ? 'selected' : '' }}>Dr. Michael Brown</option>
                        <option value="Cardiology Team A" {{ old('physician_team_name') == 'Cardiology Team A' ? 'selected' : '' }}>Cardiology Team A</option>
                        <option value="Cardiology Team B" {{ old('physician_team_name') == 'Cardiology Team B' ? 'selected' : '' }}>Cardiology Team B</option>
                        <option value="Other" {{ old('physician_team_name') == 'Other' ? 'selected' : '' }}>Other</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="nurse_name" name="nurse_name" class="form-select select2-single">
                        ...
                        <option value="Nurse Emily Davis" {{ old('nurse_name') == 'Nurse Emily Davis' ? 'selected' : '' }}>Nurse Emily Davis</option>
                        <option value="Nurse Robert Wilson" {{ old('nurse_name') == 'Nurse Robert Wilson' ? 'selected' : '' }}>Nurse Robert Wilson</option>
                        <option value="Nurse Lisa Anderson" {{ old('nurse_name') == 'Nurse Lisa Anderson' ? 'selected' : '' }}>Nurse Lisa Anderson</option>
                        <option value="Nurse James Taylor" {{ old('nurse_name') == 'Nurse James Taylor' ? 'selected' : '' }}>Nurse James Taylor</option>
                        <option value="Other" {{ old('nurse_name') == 'Other' ? 'selected' : '' }}>Other</option>
                    </select>
                    @error('nurse_name')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="next_of_kin" name="next_of_kin" class="form-input" value="{{ old('next_of_kin') }}">
                    @error('next_of_kin')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" id="next_of_kin_phone" name="next_of_kin_phone" class="form-input" value="{{ old('next_of_kin_phone') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="next_of_kin_email" name="next_of_kin_email" class="form-input" value="{{ old('next_of_kin_email') }}">
        ...
        <div class="form-actions">
            <a href="{{ route('patients.index') }}" class="mdc-button mdc-button--outlined" tabindex="-1">Cancel</a>
            <button type="submit" class="mdc-button" tabindex="999">
                Create Patient
            </button>
        </div>
    </form>
...
<style>
    ...
    /* Enhanced focus indicator - fallback for browsers that don't support :has() */
    .form-group {
...
<script>
    ...
    document.getElementById('patient-form').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Please wait while we create the patient account',
