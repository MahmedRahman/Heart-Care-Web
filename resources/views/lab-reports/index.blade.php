...
<div class="page-header">
    <div class="page-header-content">
        <div>
            ...
            <p class="page-subtitle">Manage laboratory reports and test results</p>
        </div>
        <a href="{{ route('lab-reports.create') }}" class="mdc-button">
            Add New Report
        </a>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('lab-reports.show', $report) }}" class="btn-icon btn-view" title="View">
                                    View
                                </a>
                                <a href="{{ route('lab-reports.edit', $report) }}" class="btn-icon btn-edit" title="Edit">
                                    Edit
                                </a>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="empty-state">
                            ...
                            <a href="{{ route('lab-reports.create') }}" class="mdc-button" style="margin-top: 16px;">
                                Add First Report
                            </a>
                        </td>
                    </tr>
