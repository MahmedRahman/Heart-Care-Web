...
<div class="card">
    <form action="{{ route('lab-reports.update', $labReport) }}" method="POST" class="form" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="report_name" name="report_name" class="form-input" value="{{ old('report_name', $labReport->report_name) }}" required>
                    @error('report_name')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="report_date" name="report_date" class="form-input" value="{{ old('report_date', $labReport->report_date->format('Y-m-d')) }}" required>
                    @error('report_date')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <div class="existing-file-item">
                        ...
                        <div class="file-info">
                            ...
                            <div class="file-actions-small">
                                ...
                                <form action="{{ route('lab-reports.files.delete', [$labReport, $index]) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this file?');">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <input type="file" id="files" name="files[]" class="form-file" accept=".pdf" multiple>
                    <p class="form-hint">You can upload additional PDF files. Maximum file size: 10MB per file.</p>
                    @error('files')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                    @error('files.*')
