...
@section('title', 'Add New Radiology Report')

@section('content')
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">Add New Radiology Report</h1>
            <p class="page-subtitle">Upload radiology images and reports</p>
        </div>
...
<div class="card">
    <form action="{{ route('radiology-reports.store') }}" method="POST" class="form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-section">
            <h3 class="form-section-title">Upload Files</h3>
            <div class="form-row">
                <div class="form-group" style="grid-column: 1 / -1;">
                    <label for="files" class="form-label">Files (Images/PDF) <span class="required">*</span></label>
                    <input type="file" id="files" name="files[]" class="form-file" accept="image/*,.pdf" multiple required>
                    <p class="form-hint">You can upload multiple files (JPEG, PNG, JPG, GIF, PDF). Maximum file size: 10MB per file.</p>
                    @error('files')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                    @error('files.*')
