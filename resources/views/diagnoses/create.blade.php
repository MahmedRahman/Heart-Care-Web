...
<div class="page-header">
    <div class="page-header-content">
        <div>
            <h1 class="page-title">Add New Diagnosis</h1>
            <p class="page-subtitle">Create a new diagnosis entry</p>
        </div>
...
<div class="card">
    <form action="{{ route('diagnoses.store') }}" method="POST" class="form" id="diagnosis-form">
        @csrf
        ...
        <div class="form-actions">
            <a href="{{ route('diagnoses.index') }}" class="mdc-button mdc-button--outlined">Cancel</a>
